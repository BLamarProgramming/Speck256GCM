...
fn key_schedule(key: &Vec<u64>) -> [u64; 34]{
...
fn bytes_to_words(bytes: &Vec<u8>) -> Vec<u64>{
...
fn encrypt(mut x: u64, mut y: u64, expanded_keys: &[u64; 34]) -> (u64, u64){
    for i in 0..34 {
...
fn main(){
    ...
    let expanded_keys: [u64; 34] = key_schedule(&keys);
